...
public class BatchFile extends Plugins {
    ...
    private final hudson.tasks.BatchFile builder;

    public BatchFile(Transformer transformer, hudson.tasks.BatchFile builder) {
    ...
    public String transform() {
        BatchScriptStep step = new BatchScriptStep(builder.getCommand());
